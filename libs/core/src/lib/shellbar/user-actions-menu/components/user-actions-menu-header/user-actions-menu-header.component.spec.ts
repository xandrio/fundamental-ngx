...
@Component({
    ...
    template: `
        <fd-user-actions-menu [user]="user">
            <fd-user-actions-menu-header [noBorder]="true">
                <fd-avatar
                    fd-user-actions-menu-header-addon-left
                    size="xs"
                    [colorAccent]="user.colorAccent"
                    [circle]="true"
                    backgroundImage="https://i.pravatar.cc/150"
                >
                </fd-avatar>
...
describe('UserActionsMenuHeaderComponent', () => {
    ...
    it('should contain 2 addons and one avatar', async () => {
        ...
        const addonLeft = fixture.debugElement.queryAll(
            By.css('.fd-user-actions-menu__header .fd-user-actions-menu__header-addon-left')
        );

        const addonRight = fixture.debugElement.queryAll(
            By.css('.fd-user-actions-menu__header .fd-user-actions-menu__header-addon-right')
        );

        const avatar = fixture.debugElement.queryAll(
            By.css('.fd-user-actions-menu__header .fd-user-actions-menu__user-avatar')
        );
