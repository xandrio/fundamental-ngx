...
describe('UserActionsSubmenuComponent', () => {
    ...
    it('should show 2 submenu items', async () => {
        const button = fixture.debugElement.query(By.css('.fd-shellbar__button--user-menu'));

        button.nativeElement.click();

        await whenStable(fixture);

        const listItem = fixture.debugElement.query(By.css('.fd-user-actions-menu__body .fd-list__item'));
        ...
        const submenuItems = fixture.debugElement.queryAll(By.css('.fd-user-actions-menu__body .fd-list__item'));
    ...
    it('should show submenu header with back button and title', async () => {
      ...
      const header = fixture.debugElement.query(By.css('.fd-user-actions-menu__header'));

      expect(header).toBeTruthy();

      const backButton = header.query(By.css('.fd-user-actions-menu__header-top-header .fd-button'));
      
      expect(backButton).toBeTruthy();

      const title = header.query(By.css('.fd-user-actions-menu__header-top-header fd-bar-element'));
  ...
  it('should show start menu list after click on the back button', async () => {
    ...
    const mainListItem = fixture.debugElement.queryAll(By.css('.fd-user-actions-menu__body .fd-list__item'));
    ...
    it('should show submenu footer with button', async () => {
        ...
        const footerButton = fixture.debugElement.query(By.css('.fd-user-actions-menu__footer .fd-button'));
