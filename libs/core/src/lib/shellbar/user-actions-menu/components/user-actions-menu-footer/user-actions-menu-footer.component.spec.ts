...
describe('UserActionsMenuFooterComponent', () => {
    ...
    it('should display footer', async () => {
        ...
        const footer = fixture.debugElement.query(By.css('.fd-user-actions-menu__footer'));
    ...
    it('should have align class', async () => {
        ...
        const bar = fixture.debugElement.query(By.css('.fd-user-actions-menu__footer .fd-bar__right'));
