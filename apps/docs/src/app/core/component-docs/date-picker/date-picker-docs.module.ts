...
import { DatePickerMobileComponent } from './examples/date-picker-mobile.component';
import { SegmentedButtonModule, DatePickerModule, DatePickerMobileModule } from '@fundamental-ngx/core';
